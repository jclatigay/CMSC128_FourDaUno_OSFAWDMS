...
<body>
  ...
  ?>
        ...
        <form method="POST" action="updated-course-info.php">
        ...
        <div class="form-group">
        <input placeholder="College" name="college" class="box" value="<?php echo $College;?>">
        </div>

        <div class="form-group">
        <input placeholder="Course" name="course" class="box" value="<?php echo $Course;?>">
        </div>

        <div class="form-group">
        <input  placeholder="Year Level" name="year_level" class="box" value="<?php echo $Year_level;?>">
        </div>
