...
<body>
    ...
    <div class="update-container">
        ...
        while($rows = mysqli_fetch_array($result)){
            ...
            $relative_name = $rows['relative_name'];
            $relative_occupation = $rows['relative_occupation'];
            $rel_annual_gross_salary = $rows['rel_annual_gross_salary'];
        }    
  ?>
        <div class="update-right">
        <h1 class="edit-info">EDIT RECORDS</h1>
        <form method="POST" action="updated-relative-info.php">
        ...
        <div class="form-group">
        <input placeholder="Relative's Name" name="relative_name" class="box" value="<?php echo $relative_name;?>">
        </div>

        <div class="form-group">
        <input placeholder="Relative's Occupation" name="relative_occupation" class="box" value="<?php echo $relative_occupation;?>">
        </div>

        <div class="form-group">
        <input  placeholder="Relative's Annual Gross Salary" name="rel_annual_gross_salary" class="box" value="<?php echo $rel_annual_gross_salary;?>">
        </div>
