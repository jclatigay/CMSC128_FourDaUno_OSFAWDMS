...
<body>
    ...
    <table class="view">
        <tr>
            <th><span><a class="button2" onclick="return confirm('Are you sure you want to delete all records?');" href="delete-all.php?delete">Delete All</a></span></th>
        ...
        <?php
            while($rows = $sql ->fetch_assoc()){
                ?>
            <tr>
                <td><span><a class="button2" onclick="return confirm('Are you sure you want to delete this record?');" href="delete-confirm.php?delete=<?php echo $rows['Student_ID'];?> ">Delete</a></span></td>
