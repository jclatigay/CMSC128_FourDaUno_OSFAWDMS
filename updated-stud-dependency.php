...
$sql = "UPDATE `stud_allowance_dependency` SET
        parent_dependent='{$parent_dependent}',relative_dependent='{$relative_dependent}',
        employment_dependent ='{$employment_dependent}'
