   ...
   <section class="function">
    ...
    <section class="dash-contain">
        <table class="dash">
            <tr>
                <td></td>
                <th colspan="3" class="num">Number of Scholars</th>
            </tr>
            <tr>
                <td rowspan ="5" class="obleImg"><img class="oblation" src = "../images/trans.png"/></td>
                <th rowspan="3"  class="tot">Total (<?php echo $total_scholar; ?>)</th>
            ...
            <tr>
                <th class="cac">CAC (<?php echo $cac_scholar; ?>)</th>
